"""Los senuelos que planta el canario.
...
dos copias podrian divergir, y entonces la prueba pasaria verificando unos casos
mientras el canario real planta otros — la peor version posible de tener una
prueba.
...
#: del detector: anadir uno aqui es ampliar lo que el canario vigila.
CASOS = [
    ...
    ("cvv-contexto",    "el CVV es 123 y caduca en 12/26"),
]
